...
export const servers2Port = [
  ...
  { host: "avmnite-02h", ram: 128, ports: 2 }, // lvl 213
...
export const servers3Port = [
  ...
  { host: "rothman-uni", ram: 64, ports: 3 }, // lvl 412
...
export const servers4Port = [
  { host: "aevum-police", ram: 16, ports: 4 }, // lvl 425
  ...
  { host: "unitalife", ram: 16, ports: 4 }, // lvl 815
];

export const servers5Port = [
  { host: "zb-institute", ram: 128, ports: 5 }, // lvl 732
  { host: "solaris", ram: 16, ports: 5 }, // lvl 847
